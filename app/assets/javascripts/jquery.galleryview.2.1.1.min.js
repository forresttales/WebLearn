...
(function($) {
	$.fn.galleryView = function(g) {
		...
		function buildPanels() {
			...
			if (!h.show_filmstrip) {
				//$('<img />').addClass('nav-next').attr('src', n + h.nav_theme + '/next.gif').appendTo(M).css({ /* works */
					
				$('<img />').addClass('nav-next').attr('src', '/assets/darknext.gif').appendTo(M).css({
				...
				$('<img />').addClass('nav-next').attr('src', n + h.nav_theme + 'prev.gif').appendTo(M).css({
				...
				$('<img />').addClass('nav-next').attr('src', n + h.nav_theme + 'panel-nav-next.gif').appendTo(M).css({
				...
				$('<img />').addClass('nav-next').attr('src', n + h.nav_theme + 'panel-nav-prev.gif').appendTo(M).css({
		...
		function buildFilmstrip() {
			...
			c.addClass('nav-next').attr('src', '/assets/darknext.gif').appendTo(M).css({
				'position' : 'absolute',
				'cursor' : 'pointer'
			}).click(showNextItem);
			var d = $('<img />');
			//d.addClass('nav-prev').attr('src', n + h.nav_theme + '/prev.gif').appendTo(M).css({
			d.addClass('nav-prev').attr('src', '/assets/darkprev.gif').appendTo(M).css({
				'position' : 'absolute',
				'cursor' : 'pointer'
			}).click(showPrevItem);
			if (F == 'horizontal') {
